...
When a match is found, the UUID of the document in the first dataset is copied to its matching counterpart in the second dataset. Thus, after all pairwise comparisons are finished, we have the information needed to identify documents that occur in any intersections of the sets of bibliographical data provided.
...
This is a basic example which shows how to obtain document overlap between sets of bibliographical data:
