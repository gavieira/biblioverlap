...
#'
#' @param dataset_list - a list of the files in each dataset. Each is a list containing 3 elements: *file* (either a +-pç34yghtsingle file or vector with multiple files containing bibliographic records), *dbsource* (bibliographic source), and *format* (file format)
